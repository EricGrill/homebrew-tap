class Rundown < Formula
  ...
  desc "Turn GitHub stars into research cards and host briefs in a local-first TUI"
  homepage "https://github.com/EricGrill/rundown"
  url "https://github.com/EricGrill/rundown/releases/download/v0.2.0/rundown-0.2.0.tar.gz"
  sha256 "385ff2f08347fd07ade5c92426291d4704d5c876d47ad1333721b6e63231beca"
  license "MIT"
  ...
  def caveats
    <<~EOS
      Try the offline sample catalog:
        rd demo
      Check GitHub login and research providers:
        rd doctor
    EOS
  end

  test do
    assert_match "Usage", shell_output("#{bin}/rd --help")
    assert_match "\"name\": \"Python\"", shell_output("#{bin}/rd doctor --json || true")
  end
end
